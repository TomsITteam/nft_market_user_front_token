<template>
  <header id="header" class="header bg-white" style="box-shadow:0 0.5rem 1rem rgb(0 0 0 / 3%) !important;">
    <div class="header__content">
      ...
      <div class="header__actions ml-auto">
        ...
        <div v-if="connectedWallet == false" class="d-none d-lg-flex align-items-center justify-content-center ml-4 header__action header__action--connect">
          <b-button  v-if="$wallet.connecting == true" pill variant="primary" class="base-font-weight border-0" disabled style="width:110px;height: 40px">
            {{ $t('header.connecting') }}
          </b-button>
        ...
        <div v-else  class="d-none d-lg-flex header__action header__action--profile ml-3">
...
export default {
  name: "main-header",
  components: {ModalKlipWallet, MenuDropdownItem},
  watch: {
    '$route' (to, from) {
  ...
  methods: {
    ...
    async connectWallet() {
      if (this.$wallet.isDownload() == false) {
        return
      }

      let address = await this.$wallet.connectWallet()
    }
  },
